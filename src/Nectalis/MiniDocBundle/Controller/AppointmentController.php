...
use Nectalis\MiniDocBundle\Entity\Appointment;
use Nectalis\MiniDocBundle\Form\AppointmentType;
...
class AppointmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NectalisMiniDocBundle:Appointment')->findAll();
     ...
     * @Method("POST")
     * @Template("NectalisMiniDocBundle:Appointment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NectalisMiniDocBundle:Appointment')->find($id);
     ...
     * @Method("PUT")
     * @Template("NectalisMiniDocBundle:Appointment:edit.html.twig")
     */
